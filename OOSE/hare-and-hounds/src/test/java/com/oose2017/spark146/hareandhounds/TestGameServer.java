...
//        Game[] entries = new Game[] {
//          new Game(null, "Test-1", false, df.parse("2015-04-23T23:10:15-0700")),
//          new Game(null, "Test-2", true, df.parse("2015-03-07T01:10:20-0530")),
//          new Game(null, "Test-3", false, df.parse("2010-02-19T13:25:43-0530"))
//        };
//
//        for (Game t : entries) {
...
//        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZ");
//        Game expected = new Game(null, "Test-1", false, df.parse("2015-04-23T23:10:15-0700"));
...
//        Game t = getTodos(r2).get(0);
//
//        //Send out an update with a changed title and state
//        Game updated = new Game(t.getId(), t.getTitle(), !t.isDone(), t.getCreatedOn());
...
//        List<Game> results = getTodos(r4);
//
//        //Verify that we got the right element back
//        assertEquals(1, results.size());
//
//        Game actual = results.get(0);
...
//        List<Game> expected = IntStream.range(0, entries.length)
...
//    }
//
//    private List<Game> getTodos(Response r) {
